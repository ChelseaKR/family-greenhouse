...
| CI/CD                      | Applies                                                                         | Met for current service shape — committed no-bypass ruleset + CODEOWNERS, strict required checks, OIDC deploys, workflow audit, concurrency, and `make verify` parity; production deployment retains its explicit Environment approval                                                         |
