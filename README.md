...
| Release & Versioning       | Applies — tagged releases drive prod deploys                                    | Partial — root/workspace versions are aligned at 0.35.0; tag/version and CHANGELOG gates run at the tagged ref. Release SBOM/provenance and blocking signed-tag verification remain open                                                                                                       |
