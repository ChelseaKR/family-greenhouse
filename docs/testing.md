...
| Frontend unit + component | vitest + RTL + MSW | `frontend/tests/unit/`                                                    | 96    | 660        |
...
**2,184 vitest cases** across 207 files — 1,479 backend, 705 frontend. The backend suite runs in ~17s and the frontend in ~80s (jsdom, serial by config).
