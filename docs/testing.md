...
| ------------------------- | ------------------ | ------------------------------------------------------------------------- | ----- | ---------- |
| Backend unit              | vitest             | `backend/tests/unit/{config,handlers,middleware,models,services,utils}`   | 91    | 1,317      |
...
**2,308 vitest cases** across 213 files — 1,523 backend, 785 frontend. The backend suite runs in ~17s and the frontend in ~80s (jsdom, serial by config).
