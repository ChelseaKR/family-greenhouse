...
| ------------------------- | ------------------ | ------------------------------------------------------------------------- | ----- | ---------- |
| Backend unit              | vitest             | `backend/tests/unit/{config,handlers,middleware,models,services,utils}`   | 91    | 1,313      |
| Backend integration       | vitest + supertest | `backend/tests/integration/`                                              | 8     | 199        |
| Backend RAG + pet-safety eval | vitest         | `backend/tests/eval/`                                                     | 2     | 15         |
| Frontend unit + component | vitest + RTL + MSW | `frontend/tests/unit/`                                                    | 101   | 737        |
...
**2,313 vitest cases** across 214 files — 1,531 backend, 782 frontend. The backend suite runs in ~17s and the frontend in ~80s (jsdom, serial by config).
