...
| Frontend unit + component | vitest + RTL + MSW | `frontend/tests/unit/`                                                    | 102   | 750        |
| Frontend colocated unit   | vitest             | `frontend/src/**/*.test.ts`                                               | 14    | 68         |
...
**2,338 vitest cases** across 217 files — 1,519 backend, 819 frontend. The backend suite runs in ~17s and the frontend in ~80s (jsdom, serial by config).
