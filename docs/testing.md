...
| ------------------------- | ------------------ | ------------------------------------------------------------------------- | ----- | ---------- |
| Backend unit              | vitest             | `backend/tests/unit/{config,handlers,middleware,models,services,utils}`   | 91    | 1,413      |
...
**2,470 vitest cases** across 214 files — 1,685 backend, 785 frontend. The backend suite runs in ~17s and the frontend in ~80s (jsdom, serial by config).
