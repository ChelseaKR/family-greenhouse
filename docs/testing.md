...
| Frontend unit + component | vitest + RTL + MSW | `frontend/tests/unit/`                                                    | 103   | 768        |
...
**2,373 vitest cases** across 218 files — 1,526 backend, 847 frontend. The backend suite runs in ~17s and the frontend in ~80s (jsdom, serial by config).
