...
export default function CommonToxicHouseplants() {
  return (
    <article className="prose-fg">
      ...
      <p>
        <a href="/care/pothos">Pothos</a> is the default beginner vine, and it&rsquo;s toxic to cats
        and dogs &mdash; the calcium oxalate crystals cause mouth pain, drooling, and vomiting if
        chewed. The swap is the
        <a href="/care/spider-plant">spider plant</a>: same trailing, hang-it-up habit, same
        near-indestructible temperament, but non-toxic to both cats and dogs per the ASPCA. It even
        gives you free babies on runners. It&rsquo;s the closest thing to a like-for-like
        replacement on this list.
      </p>

      <h3>Aloe vera &rarr; haworthia</h3>
      <p>
        <a href="/care/aloe-vera">Aloe</a> gets recommended as a beginner succulent and a first-aid
        plant, but it&rsquo;s toxic to cats and dogs &mdash; the gel is fine, the leaf isn&rsquo;t.
        If you want a small spiky succulent for a sunny sill, a haworthia (the little
        &ldquo;zebra&rdquo; succulents) gives you the same look and the same drought-loving,
        hard-to-overthink care, and isn&rsquo;t on the toxic list. You lose the burn-gel trick, but
        you keep the windowsill aesthetic.
      </p>

      <h3>Snake plant &rarr; cast iron plant</h3>
      <p>
        The <a href="/care/snake-plant">snake plant</a> is the go-to &ldquo;tough upright
        architectural&rdquo; plant, and its saponins make it mildly toxic to pets. For the same
        upright, neglect-tolerant, low-light silhouette without the toxicity, the cast iron plant
        (Aspidistra) is the swap &mdash; non-toxic, famously indestructible, and happy in the same
        dim corners. It grows slowly enough to test your patience, but it asks for nothing and
        won&rsquo;t hurt a curious pet.
      </p>
      ...
      <p>
        ...
        If you want showy foliage at floor level where a pet roams, a{' '}
        <a href="/care/calathea">calathea</a> is the swap: non-toxic to both per the ASPCA, with
        patterns far prettier than a <a href="/care/peace-lily">peace lily</a>&rsquo;s plain green.
        The trade is care &mdash; a calathea is fussier about water and humidity &mdash; but
      ...
      <p>
        The whole <a href="/care/heartleaf-philodendron">philodendron</a> and{' '}
        <a href="/care/monstera">monstera</a> family carries the same calcium oxalate crystals as
      ...
      <p>
        <a href="/care/dieffenbachia">Dieffenbachia</a> (&ldquo;dumb cane&rdquo;) is the one
        I&rsquo;d single out to avoid in a home with pets or small children. It&rsquo;s toxic to
        cats, dogs, and people, and its sap is harsher than the average houseplant &mdash; bad
        enough to numb and swell the mouth and throat. For similar big patterned leaves without that
        risk, a calathea is again the pet-safe swap. This is the one plant on the list where the
        right answer is often just &ldquo;don&rsquo;t.&rdquo;
      </p>
