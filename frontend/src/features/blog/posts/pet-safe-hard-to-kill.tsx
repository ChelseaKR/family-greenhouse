  ...
  return (
    <article className="prose-fg">
      <p className="lead">
        ...
        are all toxic to cats and dogs. What&rsquo;s left is a shorter, more honest list than the
        listicles admit.
      </p>
      ...
      <p>
        ...
        Ferns want humidity and even moisture, and a <a href="/care/boston-fern">Boston fern</a> in
        a dry apartment in winter sheds fronds dramatically. It clears the pet-safe bar with room to
        spare; it clears the hard-to-kill bar only if your home is humid or you&rsquo;re willing to
        fuss. Honest framing: safe, gorgeous, demanding.
      </p>
      ...
      <p>
        ...
        at the edges to tell you when they don&rsquo;t get it. Buy a{' '}
        <a href="/care/calathea">calathea</a> for its looks and its pet safety, not for forgiveness.
        If you want safe <em>and</em> tough, start with the spider plant and work up to this.
      </p>
      ...
      <p>
        ...
        the care notes so &ldquo;use filtered water&rdquo; doesn&rsquo;t live in one person&rsquo;s
        head. A spreadsheet works too. The point is to check the safety first, then build the habit
        second.
      </p>
    </article>
  );
