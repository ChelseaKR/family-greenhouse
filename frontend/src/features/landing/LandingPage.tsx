...
const differentiators = [
  ...
  },
  {
    ...
    // function, so if push is ever exempted again this sentence has to change.
    body: 'Browser or email, on the day a task is due. Set quiet hours and every reminder waits for them.',
  },
  {
    icon: ChartBarIcon,
