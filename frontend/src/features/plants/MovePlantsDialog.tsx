            ...
            >
              <Dialog.Panel className="relative w-full transform overflow-hidden rounded-lg border border-primary-100/70 bg-paper px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:max-w-lg sm:p-6">
                <button
                  type="button"
                  onClick={handleClose}
                  className="absolute right-3 top-3 inline-flex min-h-touch min-w-touch items-center justify-center rounded-md text-gray-500 hover:text-gray-700 focus:outline-hidden focus-visible:ring-2 focus-visible:ring-primary-500"
                >
